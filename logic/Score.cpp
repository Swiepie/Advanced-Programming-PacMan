...
void Score::resetGhostCombo() { ghostCombo = 0; }

void Score::addFruit(int basePoints) { currentScore += basePoints; }
...
int Score::get() const { return currentScore; }

void Score::submit() { scoreboard.addScore(currentScore); }

const std::vector<int> &Score::getTop5() const { return scoreboard.getTop5(); }