...
const std::vector<std::unique_ptr<Wall>>& World::getWalls() const { return walls; }

const std::vector<std::unique_ptr<Entity>>& World::getCollectibles() const { return collectibles; }

const std::vector<std::unique_ptr<Ghost>>& World::getGhosts() const { return ghosts; }
int World::getWidth() const { return width; }
int World::getHeight() const { return height; }

std::shared_ptr<Pacman> World::getPacman() const { return pacman; }
...
bool World::getFearMode() const { return fearmode; }
float World::getFearModeTimer() const { return fearmodeTimer; }
void World::setFearModeStart(float timer) { fearmodeStart = timer; }

int World::getPacmanLives() const { return pacmanlives; }

float World::getTime() const { return totTime; }
...
Score& World::getScore() { return score; }

int World::getRounds() const { return rounds; }
