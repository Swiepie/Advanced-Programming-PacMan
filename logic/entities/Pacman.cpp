...
void Pacman::setDirection(char direct) { direction = direct; }
char Pacman::getBufferdirection() const { return bufferdirection; }
void Pacman::setBufferdirection(char direct) { bufferdirection = direct; }
void Pacman::applyBufferdirection() { direction = bufferdirection; }
void Pacman::addMoveTime(float dt) { moveTimer += dt; }
