...
public:
  CollectibleVisitor(std::shared_ptr<Pacman> pacman, World *w, float tileWidth,
                     float tileHeight);
...
public:
  GhostCollisionVisitor(std::shared_ptr<Pacman> pacman, World *w,
...
public:
  CollisionDetectionVisitor(float x, float y, float tileWidth,
                            float tileHeight);
