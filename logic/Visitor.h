...
public:
    ...
    virtual void visit(Wall& wall) = 0;       ///< Bezoek een wall entity
    virtual void visit(Coin& coin) = 0;       ///< Bezoek een coin entity
    virtual void visit(Fruit& fruit) = 0;     ///< Bezoek een fruit entity
    virtual void visit(Pacman& pacman) = 0;   ///< Bezoek pacman entity
    virtual void visit(RedGhost& ghost) = 0;  ///< Bezoek red ghost entity
    virtual void visit(BlueGhost& ghost) = 0; ///< Bezoek bluee ghost entity
    virtual void visit(PinkGhost& ghost) = 0; ///< Bezoek pink ghost entity
};
...
private:
     ...
     * @param ghost ghost entity betrokken bij botsing
     */
...
private:
     ...
     * @param ghost ghost entity om te resetten
     */
