...
void LevelState::handleEvent(std::shared_ptr<StateManager> stateManager,
  ...
  if (event.type == sf::Event::Closed)
    ...
    case sf::Keyboard::Up:
      pacman->setBufferdirection('N');
      break;
    case sf::Keyboard::Down:
      pacman->setBufferdirection('Z');
      break;
    case sf::Keyboard::Left:
      pacman->setBufferdirection('W');
      break;
    case sf::Keyboard::Right:
      pacman->setBufferdirection('O');
      break;
    default:
      break;
    }
...
void LevelState::update(std::shared_ptr<StateManager> stateManager,
                        float deltaTime) {
  if (deltaTime > 0.5) {
    return;
  }
