...
void GhostView::chooseFearTexture(float time) {
  if (readyFrame(time)) {
    ...
    sf::IntRect rect;
    rect =
        mouthOpen ? sf::IntRect(128, 64, 16, 16) : sf::IntRect(144, 64, 16, 16);
...
// RedGhostView
RedGhostView::RedGhostView(RedGhost *g,
                           std::shared_ptr<sf::RenderWindow> window, int height,
                           int width)
...
void RedGhostView::chooseTexture(char direction, float time) {
  if (readyFrame(time)) {
    ...
    case 'N':
      rect =
          mouthOpen ? sf::IntRect(64, 64, 16, 16) : sf::IntRect(80, 64, 16, 16);
      break;
    case 'Z':
      rect = mouthOpen ? sf::IntRect(96, 64, 16, 16)
                       : sf::IntRect(112, 64, 16, 16);
      break;
    case 'W':
      rect =
          mouthOpen ? sf::IntRect(32, 64, 16, 16) : sf::IntRect(48, 64, 16, 16);
      break;
    case 'O':
      rect =
          mouthOpen ? sf::IntRect(0, 64, 16, 16) : sf::IntRect(16, 64, 16, 16);
      break;
    }
    sprite.setTextureRect(rect);
    recordFrameTime(time);
...
// BlueGhostView
BlueGhostView::BlueGhostView(BlueGhost *g,
...
void BlueGhostView::chooseTexture(char direction, float time) {
  if (readyFrame(time)) {
    ...
    case 'N':
      rect =
          mouthOpen ? sf::IntRect(64, 96, 16, 16) : sf::IntRect(80, 96, 16, 16);
      break;
    case 'Z':
      rect = mouthOpen ? sf::IntRect(96, 96, 16, 16)
                       : sf::IntRect(112, 96, 16, 16);
      break;
    case 'W':
      rect =
          mouthOpen ? sf::IntRect(32, 96, 16, 16) : sf::IntRect(48, 96, 16, 16);
      break;
    case 'O':
      rect =
          mouthOpen ? sf::IntRect(0, 96, 16, 16) : sf::IntRect(16, 96, 16, 16);
      break;
    }
    sprite.setTextureRect(rect);
    recordFrameTime(time);
...
// PinkGhostView
PinkGhostView::PinkGhostView(PinkGhost *g,
                             std::shared_ptr<sf::RenderWindow> window,
                             int height, int width)
    : GhostView(g, std::move(window), height, width) {
...
void PinkGhostView::chooseTexture(char direction, float time) {
  if (readyFrame(time)) {
    ...
    case 'N':
      rect =
          mouthOpen ? sf::IntRect(64, 80, 16, 16) : sf::IntRect(80, 80, 16, 16);
      break;
    case 'Z':
      rect = mouthOpen ? sf::IntRect(96, 80, 16, 16)
                       : sf::IntRect(112, 80, 16, 16);
      break;
    case 'W':
      rect =
          mouthOpen ? sf::IntRect(32, 80, 16, 16) : sf::IntRect(48, 80, 16, 16);
      break;
    case 'O':
      rect =
          mouthOpen ? sf::IntRect(0, 80, 16, 16) : sf::IntRect(16, 80, 16, 16);
      break;
    }
    sprite.setTextureRect(rect);
    recordFrameTime(time);
