...
/**
 * @class WorldView
 * @brief Hoofdview klasse die de volledige world rendert
 *
 * Coördineert het renderen van alle entiteiten in de world.
...
public:
    ...
    /**
     * @brief Rendert de volledige world naar het venster
