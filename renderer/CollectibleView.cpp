...
void FruitView::update(float time) {
	render();
}
...
void FruitView::render() {
	...
	circle.setPosition(screenPos.x + rectSize/2.f - rectSize/7.f,screenPos.y + rectSize/2.f - rectSize/7.f);
...
void CoinView::update(float time) {
	render();
}
...
void CoinView::render() {
	...
	circle.setPosition(screenPos.x + rectSize/2.f - rectSize/10.f,screenPos.y + rectSize/2.f - rectSize/10.f);
	window->draw(circle);
}
